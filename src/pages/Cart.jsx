      ...
      <div className='grid grid-cols-3 gap-4 mt-5 '>
          ...
          <table className='table-auto w-full'>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>product name</td>
                <td><img width={'70px'} height={'70px'} src="https://th.bing.com/th/id/OIP.tLotgCDtzgTdwJcTiXWRCwHaEK?w=1920&h=1080&rs=1&pid=ImgDetMain" alt="" /></td>
                <td>
                  <div className='flex'>
        ...
        <div className='col-span-1'>
          <div className='border rounded shadow p-5'>
            <h2 className='text-2xl font-bold my-4'>Total Amount : <span>$ 9.99</span></h2>
            <hr />
