  ...
  return (
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
      ...
      <ul className='flex-1 text-right'>
        {
          insideHome &&
          <li className='list-none inline-block px-5'><input onChange={(e)=>dispatch(searchProduct(e.target.value.toLowerCase().trim()))} style={{width:'300px'}} className='rounded p-2 text-black' type="text" placeholder='Search Products Here' /></li>
        }
